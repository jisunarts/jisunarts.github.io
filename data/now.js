...
const NOW = [
...

  {
    ...
    year: "2025–2026",
    artist: { ko: "황수현 컨셉·안무", en: "Concept and choreography by Hwang Soohyun" },
    role: { ko: "크리에이티브 프로듀서", en: "Creative Producer" },
    ...
    detail: {
      ...
      links: [
        { label: { ko: "프로그램북 →", en: "Programme Book →" }, url: "http://soohyunhwang.com/syncdesync/" },
        { label: { ko: "웹 포토북 →", en: "Web Photobook →" }, url: "https://jisunarts.github.io/syncdesync_photo" }
      ],
      media: [
...

  {
    ...
    year: "2026",
    artist: { ko: "크리스 부시 작 · 전윤환 연출 · 앤드씨어터", en: "Written by Chris Bush · Directed by Jeon Yunhwan · A.N.D.Theatre" },
    role: { ko: "드라마투르그", en: "Dramaturg" },
...

  {
    ...
    year: "2026",
    artist: { ko: "황수현 컨셉·안무·출연", en: "Concept, choreography and performance by Hwang Soohyun" },
    role: { ko: "크리에이티브 프로듀서", en: "Creative Producer" },
...

  {
    ...
    year: "2014–",
    role: { ko: "공동 창립 · 기획팀", en: "Co-founder, Planning Team" },
    partner: { ko: "아시아 독립 프로듀서 네트워크", en: "A network of independent producers across Asia" },
...

  {
    ...
    year: "2025–2026",
    role: { ko: "기획·프로듀서", en: "Programming & Producing" },
    partner: { ko: "앤드씨어터 × 프로듀서그룹도트 × 강화유니버스", en: "A.N.D.Theatre × Producer Group DOT × Ganghwa Universe" },
...

  {
    ...
    year: "2021–",
    role: { ko: "총괄 기획", en: "Programming" },
    partner: { ko: "국립현대무용단 공동 기획", en: "Co-programmed with the Korea National Contemporary Dance Company" },
    ...
    detail: {
      ...
      links: [
        { label: { ko: "자료집 2021–22 →", en: "Publication 2021–22 →" }, url: "documents.html" },
        { label: { ko: "자료집 2023 →", en: "Publication 2023 →" }, url: "documents.html" },
        { label: { ko: "자료집 2024 →", en: "Publication 2024 →" }, url: "documents.html" }
      ],
      media: []
    }
  },

  {
    ...
    year: "2020–2022",
    role: { ko: "공동 기획", en: "Co-programming" },
    partner: { ko: "예술텃밭 Arts Farm Tutbat × 프로듀서그룹 도트", en: "Arts Farm Tutbat × Producer Group DOT" },
...

  {
    ...
    year: "2024–",
    role: { ko: "기획 · 아시아 네트워크", en: "Programming" },
    ...
    detail: {
      ...
      links: [
        { label: { ko: "thenextnormalasia.com →", en: "thenextnormalasia.com →" }, url: "https://thenextnormalasia.com/" },
        { label: { ko: "포럼 영상 →", en: "Forum Video →" }, url: "https://youtu.be/sbUxGuR3LCA" }
      ],
      media: []
    }
  },

  {
    ...
    year: "2025–2027",
    role: { ko: "에코 드라마투르그", en: "Eco-dramaturg" },
    partner: { ko: "앤드씨어터", en: "A.N.D.Theatre" },
    cover: "img/works/asian-eyes/01.jpg",
    summary: { ko: "태국 메솟 · 치앙마이에서 미얀마 사람들의 목소리를 담는 리서치. 2025–2026 진행 중.", en: "Research gathering the voices of Myanmar people in Mae Sot and Chiang Mai, Thailand. Ongoing, 2025–2026." },
...

  {
    ...
    title_en: "Aesth:ethics",
    year: "2024–",
    role: { ko: "기획", en: "Concept & Planning" },
    partner: { ko: "Academy for Theatre and Digitality (Dortmund) × 프로듀서그룹 도트 (서울)", en: "Academy for Theatre and Digitality (Dortmund) × Producer Group DOT (Seoul)" },
    cover: "img/works/aesthethics.jpg",
    page: "projects/aesthethics.html",
    ...
    detail: {
      ...
      links: [
        { label: { ko: "theater.digital →", en: "theater.digital →" }, url: "https://theater.digital/en/" }
      ],
      photos: {
        dir: "img/works/",
        items: [
