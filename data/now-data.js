// '지금' 페이지 전체 교체용 데이터 — 공연 3 + 프로젝트 6, 총 9건
// 필드 이름은 기존 now.js 규칙에 맞춰 병합할 것.
// 사진(cover / media)은 다음 차례에 추가 예정 — 현재는 있는 것만 채워 둠.
...
const NOW = [
...

  {
    ...
    url: "projects/sync-de-sync.html",
    detail: {
      runs: [
      ...
      links: [
        { label: "프로그램북 →", url: "https://soohyunhwang.com/syncdesync/" },
...

  {
    ...
    detail: {
      runs: [
        "2026.10.15(목) – 10.17(토) · 대학로예술극장 소극장"
      ],
      running: "50분",
...

  {
    ...
    cover: "img/ganghwa/01.jpg",
    url: "projects/ganghwa.html",
    tags: ["경계와공존", "기후위기", "지역과공동체", "국제협력", "이동성", "과정중심"]
    // 상세 내용은 기존 강화도 상세 페이지 그대로 유지
  },
